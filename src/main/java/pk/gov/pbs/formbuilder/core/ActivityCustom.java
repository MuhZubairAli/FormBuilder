...
import pk.gov.pbs.formbuilder.toolkits.UXToolkit;
import pk.gov.pbs.formbuilder.utils.ThemeUtils;

public abstract class ActivityCustom extends AppCompatActivity {
    ...
    protected void setActivityTitle(@NonNull String subtitle){
        setActivityTitle(getString(R.string.app_title),subtitle);
    }

    protected void setActivityTitle(int subtitle){
        setActivityTitle(getString(R.string.app_title),getString(subtitle));
    }
            ...
            if (!isDestroyed() && !isFinishing()) {
                if(dialogLocationSettings == null) {
                    dialogLocationSettings = mUXToolkit.buildAlertDialogue(
                            ...
                            ,getString(R.string.label_btn_app_settings)
                            , () -> {
