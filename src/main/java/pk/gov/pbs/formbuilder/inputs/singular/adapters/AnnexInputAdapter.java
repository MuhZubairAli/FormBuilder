...
public class AnnexInputAdapter extends SingularInputAdapter {
    public AnnexInputAdapter(SingularInput[] singularInputs){
        super(R.layout.container_ll, singularInputs);
    }

    public AnnexInputAdapter(SingularInput[] singularInputs, Validator validator) {
    ...
    public ValueStore[][] getAnswers() {
        List<ValueStore[]> answers = new ArrayList<>();
